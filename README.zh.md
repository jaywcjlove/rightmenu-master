...
- **菜单栏快捷导航**：通过菜单栏快速访问常用文件夹与应用，提升操作效率
- **新建文件**：一键创建指定格式文件，可导入自定义模板
- **文件二维码分享**：生成二维码与局域网链接，快速分享文件
- **常用文件夹**：自定义常用目录，一键直达或新建终端窗口
- **网站导航**：支持将常用文件夹设置为[网站导航](https://github.com/jaywcjlove/bookmarks)。
- **文件夹访问历史**：记录文件夹打开路径，可快速回溯访问
- **常用程序**：快速启动编辑器、终端/iTerm等常用命令行工具
- **自定义脚本**：编写自定义脚本并添加至右键菜单
- **复制工具集**：多项复制功能，便捷管理文件路径与名称
- **复制文件路径**：一键复制文件绝对路径
- **复制文件夹/文件名**：快速复制目录或文件名称
- **快捷粘贴图片**：直接将图片粘贴到访达文件夹内
- **直接删除**：快速移除文件/文件夹，简化操作步骤
- **识别 Git 远程链接菜单**：自动识别仓库并添加打开远程Git地址选项
- **显示选中项大小**：批量选中文件/文件夹，展示总占用体积与分项大小
- **自定义文件夹图标颜色**：一键修改、自定义文件夹图标配色
- **剪切粘贴功能**：支持⌘X剪切、⌘V粘贴，丰富文件操作方式
- **创建桌面替身**：生成软链接快捷方式发送至桌面
- **复制到指定位置**：将文件/文件夹快速复制至目标路径
- **移动到指定位置**：将文件/文件夹快速剪切移动至目标路径
- **图片格式转换**：提供多种图像格式互转功能
- **生成icns图标**：快捷引导制作icns图标文件
- **文件/文件夹锁定**：通过菜单快捷键快速锁定项目防止修改
- **应用程序快速预览**：为App程序文件添加QuickLook预览支持
- **代码高亮预览**：代码文件预览时自带语法高亮显示
- **新增预览插件**：支持Icon Composer .icon格式文件快速预览
- **外接磁盘展示**：在状态栏菜单栏自动挂载并显示外接存储设备
